...
class Edit extends React.Component {
    render() {
        const { _id, name, imgFront, imgBack, team, year, sport, condition, quantity, value, isRookie } = this.props.oldschool
        return (
            <OldSchoolDefault>
                <div className="container">
                    ...
                    <div className="form-container">
                        ...
                        <form action={`/cards/${_id}?_method=PUT`} method="POST" className="new-form">
